...
class FlexusSplitListTile extends StatefulWidget {
  final String? query;
  final String title;
  final Widget subtitle;
  final Function()? onPressed;

  const FlexusSplitListTile({
    super.key,
    this.query,
    required this.title,
  ...
  @override
  FlexusSplitListTileState createState() => FlexusSplitListTileState();
}

class FlexusSplitListTileState extends State<FlexusSplitListTile> {
  @override
